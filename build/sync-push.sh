...
main() {
  ...
  then
    ...
    {
      git clone https://user:${GH_TOKEN}@github.com/JounQin/react-ssr.git sync -b assets
    } || {
      ...
      git remote add origin https://user:${GH_TOKEN}@github.com/JounQin/react-ssr.git
      cd ..
    }
